  ...
  return {
    ...
    workflow: {
      ...
      rules: [
        ...
        "Use one valuation currency per joined transaction and provide value_decimal for every foreign-currency line.",
        "Prefer an explicit statement USD value over a market estimate. When no statement value exists, value an asset-denominated network fee with its actual native quantity and a transaction-time reference rate, rounded once to the valuation currency's smallest unit.",
        ...
        "Use remainingLineItemMovementUnits as a hard interval constraint. First treat a nonzero residual after mapped lines as missing or misclassified evidence.",
