...
const descriptions = {
  ...
  import_single_account_statement: mutate("Preview statement transactions for one confirmed account; dated balances are optional, and the designated suspense account receives unresolved counterlines.", ["CREATE"]),
